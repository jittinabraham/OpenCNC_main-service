...
func (x *Adapter) GetProtocol() string {
	if x != nil {
		return x.Protocol
	}
	return ""
...
func (x *Adapter) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
var file_adapter_proto_rawDesc = []byte{
	...
	0x0d, 0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x3f,
	0x0a, 0x07, 0x41, 0x64, 0x61, 0x70, 0x74, 0x65, 0x72, 0x12, 0x1a, 0x0a, 0x08, 0x50, 0x72, 0x6f,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42,
	0x11, 0x5a, 0x0f, 0x2f, 0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x2d, 0x63, 0x6f, 0x6e, 0x66,
...
var file_adapter_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_adapter_proto_goTypes = []interface{}{
	(*Adapter)(nil), // 0: monitorConfig.Adapter
}
